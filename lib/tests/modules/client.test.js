...
var _client = _interopRequireWildcard(require('../../modules/client'));
...
describe('Client', function() {
  ...
  it('should set cache if provided', function() {
    var myCache = (0, _client.defaultCache)({});
    var client = new _client.default({
      cache: myCache,
      url: 'test',
    });
  ...
  describe('cache', function() {
    it('should provide a valid cache by default', function(done) {
      ...
      var myCache = (0, _client.defaultCache)(store);
      var client = new _client.default({
        cache: myCache,
        url: 'test',
      });
      ...
      Promise.all([
        ...
        client.cache.read('test'),
        client.cache.update(function(acc, key) {
          if (key === 'test') {
            acc[key] = 6;
          }
        }),
