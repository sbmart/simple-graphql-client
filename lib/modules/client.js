  ...
  (function() {
      ...
      return new Promise(function(resolve, reject) {
        ...
        _this2.cache.read(hash).then(function(data) {
          if (data && !skipCache) {
            ...
            var fetchOptions =
              typeof _this2.fetchOptions === 'function'
                ? _this2.fetchOptions()
                : _this2.fetchOptions; // Fetch data
            ...
            fetch(
              ...
              .then(function(response) {
                if (response.data) {
                  ...
                  var _typeNames2 = (0, _typenames.gankTypeNamesFromResponse)(
                    response.data
    ...
    _proto.executeMutation = function executeMutation(mutationObject) {
      ...
      return new Promise(function(resolve, reject) {
        ...
        var fetchOptions =
          typeof _this3.fetchOptions === 'function'
            ? _this3.fetchOptions()
            : _this3.fetchOptions; // Call mutation
        ...
        fetch(
          ...
          .then(function(response) {
            if (response.data) {
              ...
              var _typeNames3 = (0, _typenames.gankTypeNamesFromResponse)(
                response.data
